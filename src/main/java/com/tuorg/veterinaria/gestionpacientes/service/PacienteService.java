...
public class PacienteService {
     ...
     * asociada. Esta operación es fundamental en el flujo de la clínica
     * veterinaria.
     * 
     ...
     * 7️⃣ Crear Historia Clínica AUTOMÁTICAMENTE (Invariante: todo paciente debe
     * tenerla)
     ...
     *                - identificadorExterno: UUID (opcional, se genera si no
     *                existe)
     * 
     ...
     *          // Resultado: idPaciente=1, nombre=Max, especie=perro,
     *          historia=creada automáticamente
     */
    @Transactional
    public PacienteResponse registrarPaciente(PacienteRequest request) {
        ...
        Cliente cliente = obtenerCliente(Objects.requireNonNull(request.getClienteId()));
        ...
        // Generar identificador externo (UUID único para identificación sin exponer ID
        // interno)
        ...
        // Justificación: Todo paciente veterinario DEBE tener al menos una historia
        // clínica
    ...
    public PacienteResponse obtener(Long id) {
        Paciente paciente = obtenerPacienteEntidad(Objects.requireNonNull(id));
    ...
    public List<PacienteResponse> obtenerPorCliente(Long clienteId) {
        obtenerCliente(Objects.requireNonNull(clienteId));
        return pacienteRepository.findByClienteId(Objects.requireNonNull(clienteId))
                .stream()
                .map(this::mapToResponse)
                .toList();
    }
     ...
     * Utiliza patrón de "actualización selectiva": solo campos no-null en el
     * request
     ...
     *          PacienteResponse resultado = pacienteService.actualizarDatos(1L,
     *          actualizar);
     */
    @Transactional
    ...
    public PacienteResponse actualizarDatos(Long id, PacienteUpdateRequest request) {
        ...
        Paciente pacienteExistente = obtenerPacienteEntidad(Objects.requireNonNull(id));
        ...
        if (request.getClienteId() != null) {
            Cliente nuevoCliente = obtenerCliente(Objects.requireNonNull(request.getClienteId()));
        ...
        Paciente actualizado = pacienteRepository.save(Objects.requireNonNull(pacienteExistente));

        // ✓ PASO 6: Auditoría - timestamp actualizado automáticamente por
        // @EntityListeners
    ...
    public String generarResumenClinico(Long id) {
        ...
        resumen.append("Peso: ").append(paciente.getPesoKg() != null ? paciente.getPesoKg() + " kg" : "N/A")
                .append("\n");
        resumen.append("Estado de salud: ")
                .append(paciente.getEstadoSalud() != null ? paciente.getEstadoSalud() : "N/A").append("\n");
    ...
    private Cliente obtenerCliente(Long clienteId) {
        Usuario usuario = usuarioRepository.findById(Objects.requireNonNull(clienteId))
