...
public class SecurityConfig {
    ...
    @Bean
        ...
        http
                ...
                // Nota: Las rutas son relativas al context-path (/api), 
                // así que /health es accesible como /api/health
                .requestMatchers("/health", "/ping", "/error").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Exponer headers de autorización y para imágenes
